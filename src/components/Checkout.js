...
function Copyright() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      {"Copyright © "}
      <Link color="inherit" href="https://www.themecloud.io">
        Aero Flight
      </Link>{" "}
            ...
            {activeStep === steps.length - 1 ? (
              <React.Fragment>
                ...
                <Typography variant="subtitle1">
                  Votre numéro de vol est #2001539. Un email confirmant votre
                  vol vous a été envoyé. Nous vous tiendrons informé lorsque
                  vous pourrez choisir votre siège.
                </Typography>
              </React.Fragment>
            ) : (
              <React.Fragment>
